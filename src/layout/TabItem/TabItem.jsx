    ...
    return (
        <div className='max-w-6xl mx-auto'>
            <div className='space-y-5 mb-10'>
                ...
                <p className='text-center tabs-xl w-4/6 mx-auto'>Each dish is crafted with perfect care by our expert chefs, full of flavor and passion. Our menu offers a wide variety of both local and international cuisine — everything you love, from start to finish. Choose your favorite appetizers, main courses, beverages, and delightful desserts.</p>
            </div>
            <Tabs>
